...
OUTPUT_PATH = "data/transcripts/translation_bakeoff_nllb.tsv"
OPUS_MODEL_PATH = "models/nllb-200-distilled-600M-ct2"
OPUS_TOKENIZER_NAME = "facebook/nllb-200-distilled-600M"
...
def translate_opus(translator, tokenizer, text):
    ...
    out_tokens = results[0].hypotheses[0][1:]  # skip the target lang token
...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained(OPUS_TOKENIZER_NAME, src_lang="deu_Latn")
